...
export function SalesImportDialog({
  ...
  const parseExcel = (data: ArrayBuffer) => {
    try {
      ...
      alert(
        "Error parsing Excel file. Please ensure the file is a valid Excel document.",
      );
    }
  };
  ...
  const validateAndPreview = () => {
    ...
    const requiredFields = APP_FIELDS.filter((f) => f.required).map(
      (f) => f.value,
    );
  ...
  const handleImport = async () => {
    ...
    const validData = csvData.filter(
      (row) => !preview.errors.some((e) => e.row === row._rowNumber),
    );
      ...
      try {
        ...
        if (reverseMapping["transactionDate"]) {
          transactionData.transactionDate = new Date(
            row[reverseMapping["transactionDate"]],
          )
            .toISOString()
            .split("T")[0];
        }
    ...
    >
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Import multiple sales transactions from a CSV or Excel file with
          ...
          <div className="space-y-4">
            <div className="border-2 border-dashed rounded-lg p-8 text-center">
              ...
              <p className="text-xs text-muted-foreground mb-4">
                Select a CSV or Excel file (.xlsx, .xls) containing your sales
                transactions
              </p>
              <input
                ref={fileInputRef}
            ...
            <Alert>
              ...
              <AlertDescription className="text-xs">
                Your file should include columns for amount, date, and
                salesperson email at minimum. The system will auto-detect and
                suggest field mappings in the next step.
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 p-3 rounded-lg">
              ...
              <p className="text-xs text-blue-700 dark:text-blue-300">
                Map your columns to the appropriate fields. Required fields are
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {csvColumns.map((column) => (
                <div
                  key={column.name}
                  className="grid grid-cols-2 gap-4 items-start border-b pb-3"
                >
                  <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleMapping(column.name, value)
                      }
                    >
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 pt-4 border-t">
              ...
              <Button
                ...
                className="flex-1"
              >
                Import {preview.validRows} Transaction
