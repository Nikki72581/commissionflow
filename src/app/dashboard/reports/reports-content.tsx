...
import {
  ...
  getCommissionTrends,
  getTopPerformers,
  getCommissionExportData,
} from "@/app/actions/dashboard";
import { DateRange, DateRangePreset } from "@/lib/date-range";
    ...
    try {
      ...
      switch (format) {
        case "csv":
          exportToCSV(
            data,
            `commission-report-${new Date().toISOString().split("T")[0]}`,
          );
          break;
        case "pdf":
          await exportToPDF(
                  ...
                  <TableBody>
                    {performers.map((performer, index) => {
                      const averageSaleAmount =
                        performer.totalSales / performer.salesCount;
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold">
                    {formatCurrency(
                      stats.salesCount > 0
                        ? stats.totalSales / stats.salesCount
                        : 0,
                    )}
                  </span>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {stats.averageCommissionRate.toFixed(2)}%
                        </span>
                      </div>
                    </div>
                  </div>
